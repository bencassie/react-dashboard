...
function ChartJsPieChartInner({ data, isLoading, error, options }: ChartComponentProps) {
    ...
    <Card>
      ...
      <CardContent>
        <div className="h-96 w-full">
          <Pie data={ds} options={chartOptions} />
        </div>
      </CardContent>
    </Card>
  );
...
const ChartJsPieChart = memo(ChartJsPieChartInner);
