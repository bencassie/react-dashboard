...
function PlotlyPieChartInner({ data, isLoading, error, options }: ChartComponentProps) {
  ...
  const labels = data?.map((p: any) => p.name) ?? [];
...
const PlotlyPieChart = memo(PlotlyPieChartInner);
PlotlyPieChart.displayName = "PlotlyPieChart";
